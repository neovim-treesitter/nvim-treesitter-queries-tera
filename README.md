# nvim-treesitter-queries-tera

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tera/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tera/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tera**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tera",
...
- [ ] Changes are scoped to `tera` — do not include files for other languages
